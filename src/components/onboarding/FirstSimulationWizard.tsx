        ...
        <div className="bg-gradient-to-r from-primary/10 via-purple-500/10 to-primary/10 border-b border-border p-6 flex items-start justify-between">
          <div>
            ...
            <DialogDescription className="mt-2 text-base text-foreground/80">
              Let's run your first founder test in about a minute.
            </DialogDescription>
          </div>
        </div>
        ...
        <div className="p-6 relative min-h-[300px] flex flex-col justify-center">
          {step === 1 && (
            <div className="space-y-6 animate-fade-in text-center">
              <h3 className="text-xl font-bold">Step 1: Create a sample customer profile</h3>
              <p className="text-muted-foreground">We created a sample customer profile based on a typical B2B SaaS buyer.</p>
          ...
          {step === 2 && (
            <div className="space-y-6 animate-fade-in">
              <h3 className="text-xl font-bold flex items-center gap-2">
                Step 2: Ask the profile
              </h3>
              <div className="space-y-2">
                <label className="text-sm font-medium text-muted-foreground">Question to test</label>
                <Input 
                  value={query}
              ...
              {mockLoading ? (
                <div className="flex flex-col items-center justify-center py-6 space-y-4">
                  ...
                  <p className="text-sm text-primary font-medium animate-pulse">Running your AI test...</p>
                </div>
              ) : (
          ...
          {step === 3 && (
            <div className="space-y-6 animate-fade-in">
              <div className="flex items-center gap-2 text-emerald-500 font-bold mb-4">
                ...
                Done. You have a fast first signal.
              </div>
              
              <div className="bg-muted border border-border rounded-xl p-5 relative">
                <h4 className="font-semibold text-sm mb-2 text-primary">Sample profile response:</h4>
              ...
              <div className="pt-4 text-center space-y-4">
                <p className="text-sm text-muted-foreground">Next, compare this signal with more profiles or check it with real customers.</p>
